...
public class TestArragememtAdapter extends BaseAdapter {
	...
	public TestArragememtAdapter(Context mContext, List<AllGrades> atable) {
		this.atable = atable;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.SDXF.setText("考试时间:     "+atable.get(position).getSDXF());
		viewHolder.KCCJ.setText("教室号:       "+atable.get(position).getKCCJ());
		viewHolder.BKCJ.setText("座位号:       "+atable.get(position).getBKCJ());
		viewHolder.BZF.setText("备注：        "+atable.get(position).getBZF());
