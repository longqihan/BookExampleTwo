...
public class MyFragment3 extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mMainView = inflater.inflate(R.layout.page3, container, false);
		newslistview = (ListView) mMainView.findViewById(R.id.news_list3);
			...
			public void run() {
				try {
					Document document = Jsoup
							.connect(
									"http://jwc.jxnu.edu.cn/Default.aspx?Action=Jwtz&Type=3")
							.get();
